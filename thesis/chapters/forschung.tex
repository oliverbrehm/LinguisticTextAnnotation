...
\todo{Alternativen, welche? könnten zusätzlich oder anstelle des CELEX verwendet werden. z.b. PhonoLex Core, besser als CELEX, umfangreicher (quelle!), aber nicht kostenfrei}\\
