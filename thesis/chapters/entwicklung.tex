...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.75\linewidth]{figures/frontend/uml-annotationtext}
...
\begin{figure}[h!]
	...
	\caption{UML Klassendiagramm der Textkonfiguration mit der Wortartkonfiguration (bestehend aus den Einstellungen für alle 12 Wortarten)}
	\label{fig:textconf}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\linewidth]{figures/frontend/textvorschau}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.75\linewidth, frame]{figures/frontend/texteingabe}
