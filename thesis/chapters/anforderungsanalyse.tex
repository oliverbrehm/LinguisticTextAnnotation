...
Diese Aufteilung ist in der Webentwicklung weit verbreitet\cite{Fielding:2000:ASD:932295} \tocite{front backend} und bietet einige Vorteile gegenüber einem komplett integriertem Gesamtsystem:
...
\begin{figure}[h!]
	...
	\caption{Funktionsweise einer AngularDart Webanwendung \todo{quelle: https://webdev.dartlang.org/angular/guide/architecture}}
